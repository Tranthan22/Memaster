...
// 设置颜色及其透明度
renderer.setClearColor(new THREE.Color("rgba(0,0,0,0.1)"));
...
new THREE.OBJLoader().load(
  ...
  (obj) => {
    ...
    heart.material = new THREE.MeshBasicMaterial({
      color: new THREE.Color("rgba(0,0,0,0.1)"),
    });
...
function onWindowResize() {
  ...
  renderer.setSize(window.innerWidth*0.75,0.75* window.innerHeight);
}
